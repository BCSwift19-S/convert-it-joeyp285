...
class ViewController: UIViewController {
    ...
    func calculateConversion() {
        ...
        case "liters to quarts":
            outputValue = inputValue * 1.05669
        default:
            showAlert(title: "Unexpected Error", message: "Contact the developer and share that the \(conversionString) could not be identified.")
        }
